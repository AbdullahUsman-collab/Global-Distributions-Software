...
exports.MockUserAdapter = void 0;
exports.resetUserStore = resetUserStore;
...
class MockUserAdapter {
    ...
    async findByUsername(tenantId, username) {
        return (users.find((u) => u.tenantId === tenantId &&
            u.username.toLowerCase() === username.toLowerCase()) || null);
    }
    /**
     * Find user by ID.
     */
...
exports.MockUserAdapter = MockUserAdapter;
