...
exports.AgingReportService = void 0;
/* ─── Service ──────────────────────────────────────────────── */
class AgingReportService {
     ...
     */
    async generateReport(tenantId, mode, asOfDate, partyId) {
        if (mode === 'customer') {
    ...
    /* ─── Customer Aging ──────────────────────────────────────── */
    async generateCustomerAging(tenantId, asOfDate, partyId) {
        // Fetch all customers
        ...
        for (const customer of customers) {
            ...
            const sorted = [...filteredEntries].sort((a, b) => a.entryDate.localeCompare(b.entryDate) || a.voucherNumber - b.voucherNumber);
    ...
    /* ─── Supplier Aging ──────────────────────────────────────── */
    async generateSupplierAging(tenantId, asOfDate, partyId) {
        // Fetch all suppliers
     ...
     */
    allocateAging(sortedEntries, asOfDate, accountType) {
        ...
        const buckets = { current: 0, d1_30: 0, d31_60: 0, d61_90: 0, d91_120: 0, d120plus: 0 };
    ...
    sumAging(rows) {
        const totals = { current: 0, d1_30: 0, d31_60: 0, d61_90: 0, d91_120: 0, d120plus: 0 };
...
exports.AgingReportService = AgingReportService;
