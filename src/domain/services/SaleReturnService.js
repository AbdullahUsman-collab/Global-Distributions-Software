...
class SaleReturnService {
    constructor(voucherRepo, inventoryRepo, customerRepo) {
     ...
     */
    async createSaleReturn(tenantId, dto, createdBy, role = 'ADMIN') {
     ...
     */
    async postSaleReturn(tenantId, voucherId, role = 'ADMIN') {
