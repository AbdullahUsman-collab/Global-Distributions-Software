...
class PurchaseService {
    constructor(coaRepo, voucherRepo, inventoryRepo, supplierRepo) {
     ...
     */
    async createPurchaseBill(tenantId, dto, createdBy, role = 'ADMIN') {
        (0, AuthorizationService_1.requirePermission)(role, AuthorizationService_1.Permissions.PURCHASES_CREATE);
     ...
     */
    async postPurchaseBill(tenantId, voucherId, role = 'ADMIN') {
        (0, AuthorizationService_1.requirePermission)(role, AuthorizationService_1.Permissions.PURCHASES_POST);
     ...
     */
    async getPurchaseBills(tenantId) {
        return this.voucherRepo.getVouchersByTenantId(tenantId, { voucherType: 'PV' });
    }
    /**
     * Get a single purchase bill by id.
     */
    async getPurchaseBillById(tenantId, id) {
        return this.voucherRepo.getVoucherById(tenantId, id);
    }
    /**
     * Delete a DRAFT purchase bill.
     */
    async deletePurchaseBill(tenantId, id, role = 'ADMIN') {
        (0, AuthorizationService_1.requirePermission)(role, AuthorizationService_1.Permissions.PURCHASES_DELETE);
