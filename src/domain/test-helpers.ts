...
export const SEED_ACCOUNTS: AccountHead[] = [
  ...
  { id: 'acc-41104', tenantId: TENANT_ID, accountCode: '41104', accountName: 'Sales Return', parentId: 'acc-411', level: 4, accountType: 'REVENUE', normalBalance: 'CREDIT', isPosting: true, isSummary: false, isActive: true, legacyMainHeadNo: 200 },
