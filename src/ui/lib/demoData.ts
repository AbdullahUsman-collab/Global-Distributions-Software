...
const DEMO_PRODUCTS = [
  { id: 'prod-01', tenantId: T, sku: 'PRD-001', name: 'Milk 1 Liter', category: 'Dairy', unit: 'Ltr', pcsPerCarton: 12, saleRate: 280, purchaseRate: 240, retailPrice: 300, tradeDiscount: 2, tradeOffer: 'Buy 5 Get 1', minQuantity: 10, hsCode: '0401.10', gstType: 'VAT', gstPercent: 17, fedPercent: 0, advanceTaxSalePercent: 0, advanceTaxPurchasePercent: 0, furtherTaxPercent: 0, isActive: true },
  { id: 'prod-02', tenantId: T, sku: 'PRD-002', name: 'Milk 500ml', category: 'Dairy', unit: 'Pcs', pcsPerCarton: 24, saleRate: 160, purchaseRate: 130, retailPrice: 170, tradeDiscount: 0, tradeOffer: '', minQuantity: 20, hsCode: '0401.10', gstType: 'VAT', gstPercent: 17, fedPercent: 0, advanceTaxSalePercent: 0, advanceTaxPurchasePercent: 0, furtherTaxPercent: 0, isActive: true },
  ...
  { id: 'prod-04', tenantId: T, sku: 'PRD-004', name: 'Cooking Oil 1L', category: 'Oil', unit: 'Btl', pcsPerCarton: 12, saleRate: 580, purchaseRate: 480, retailPrice: 620, tradeDiscount: 2, tradeOffer: '', minQuantity: 12, hsCode: '1511.00', gstType: 'VAT', gstPercent: 17, fedPercent: 0, advanceTaxSalePercent: 1, advanceTaxPurchasePercent: 1, furtherTaxPercent: 5, isActive: true },
  ...
  { id: 'prod-06', tenantId: T, sku: 'PRD-006', name: 'Ghee 1kg', category: 'Ghee', unit: 'Kg', pcsPerCarton: 20, saleRate: 720, purchaseRate: 600, retailPrice: 780, tradeDiscount: 2, tradeOffer: 'Buy 10 Get 1', minQuantity: 10, hsCode: '0405.00', gstType: 'VAT', gstPercent: 17, fedPercent: 0, advanceTaxSalePercent: 1, advanceTaxPurchasePercent: 1, furtherTaxPercent: 0, isActive: true },
  { id: 'prod-07', tenantId: T, sku: 'PRD-007', name: 'Pasta 500g', category: 'Food', unit: 'Pcs', pcsPerCarton: 30, saleRate: 180, purchaseRate: 140, retailPrice: 200, tradeDiscount: 0, tradeOffer: '', minQuantity: 20, hsCode: '1905.20', gstType: 'VAT', gstPercent: 17, fedPercent: 0, advanceTaxSalePercent: 0, advanceTaxPurchasePercent: 0, furtherTaxPercent: 0, isActive: true },
  { id: 'prod-08', tenantId: T, sku: 'PRD-008', name: 'Tea 950g', category: 'Beverages', unit: 'Pcs', pcsPerCarton: 12, saleRate: 850, purchaseRate: 720, retailPrice: 900, tradeDiscount: 3, tradeOffer: '', minQuantity: 10, hsCode: '0902.10', gstType: 'VAT', gstPercent: 17, fedPercent: 0, advanceTaxSalePercent: 0, advanceTaxPurchasePercent: 0, furtherTaxPercent: 0, isActive: true },
  { id: 'prod-09', tenantId: T, sku: 'PRD-009', name: 'Sugar 1kg', category: 'Grocery', unit: 'Kg', pcsPerCarton: 50, saleRate: 140, purchaseRate: 120, retailPrice: 150, tradeDiscount: 0, tradeOffer: '', minQuantity: 50, hsCode: '1701.10', gstType: '8TH', gstPercent: 0, fedPercent: 0, advanceTaxSalePercent: 0, advanceTaxPurchasePercent: 0, furtherTaxPercent: 0, isActive: true },
  { id: 'prod-10', tenantId: T, sku: 'PRD-010', name: 'Rice 5kg', category: 'Grocery', unit: 'Pcs', pcsPerCarton: 10, saleRate: 950, purchaseRate: 800, retailPrice: 1020, tradeDiscount: 2, tradeOffer: '', minQuantity: 10, hsCode: '1006.30', gstType: '8TH', gstPercent: 0, fedPercent: 0, advanceTaxSalePercent: 0, advanceTaxPurchasePercent: 0, furtherTaxPercent: 0, isActive: true },
  { id: 'prod-11', tenantId: T, sku: 'PRD-011', name: 'Flour 10kg', category: 'Grocery', unit: 'Pcs', pcsPerCarton: 8, saleRate: 1200, purchaseRate: 1050, retailPrice: 1280, tradeDiscount: 2, tradeOffer: '', minQuantity: 8, hsCode: '1101.00', gstType: '8TH', gstPercent: 0, fedPercent: 0, advanceTaxSalePercent: 0, advanceTaxPurchasePercent: 0, furtherTaxPercent: 0, isActive: true },
  ...
  { id: 'prod-16', tenantId: T, sku: 'PRD-016', name: 'Cold Drinks 1.5L', category: 'Beverages', unit: 'Btl', pcsPerCarton: 12, saleRate: 200, purchaseRate: 160, retailPrice: 220, tradeDiscount: 0, tradeOffer: 'Buy 5 Get 1', minQuantity: 12, hsCode: '2202.10', gstType: 'VAT', gstPercent: 17, fedPercent: 5, advanceTaxSalePercent: 0, advanceTaxPurchasePercent: 0, furtherTaxPercent: 0, isActive: true },
  { id: 'prod-17', tenantId: T, sku: 'PRD-017', name: 'Water 1.5L', category: 'Beverages', unit: 'Btl', pcsPerCarton: 12, saleRate: 80, purchaseRate: 55, retailPrice: 90, tradeDiscount: 0, tradeOffer: '', minQuantity: 12, hsCode: '2201.10', gstType: 'VAT', gstPercent: 17, fedPercent: 0, advanceTaxSalePercent: 0, advanceTaxPurchasePercent: 0, furtherTaxPercent: 0, isActive: true },
  ...
  { id: 'prod-19', tenantId: T, sku: 'PRD-019', name: 'Salt 1kg', category: 'Grocery', unit: 'Kg', pcsPerCarton: 50, saleRate: 65, purchaseRate: 45, retailPrice: 75, tradeDiscount: 0, tradeOffer: '', minQuantity: 50, hsCode: '2501.00', gstType: '8TH', gstPercent: 0, fedPercent: 0, advanceTaxSalePercent: 0, advanceTaxPurchasePercent: 0, furtherTaxPercent: 0, isActive: true },
...
export function handleDemoRequest(path: string, method: string, body?: any): any {
  ...
  if (method === 'GET') {
    ...
    // Ledger — /api/ledger/:accountId (filtered by account code)
    const ledgerAccount = matchPath('/api/ledger/:accountId', cleanPath);
    if (ledgerAccount) {
      const accountId = ledgerAccount.groups!.accountId;
      const entries = DEMO_LEDGER.filter(e => e.accountId === accountId);
      let running = 0;
      return entries.map(e => { running += e.debit - e.credit; return { ...e, balance: running }; });
    }
    // Ledger — /api/ledger (all entries)
